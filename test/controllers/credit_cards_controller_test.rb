...
class CreditCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit_card" do
    assert_difference('CreditCard.count') do
      post credit_cards_url, params: { credit_card: { address_id: @credit_card.address_id, month: @credit_card.month, number: @credit_card.number, purchaser_id: @credit_card.purchaser_id, year: @credit_card.year } }
    end
  ...
  test "should update credit_card" do
    patch credit_card_url(@credit_card), params: { credit_card: { address_id: @credit_card.address_id, month: @credit_card.month, number: @credit_card.number, purchaser_id: @credit_card.purchaser_id, year: @credit_card.year } }
