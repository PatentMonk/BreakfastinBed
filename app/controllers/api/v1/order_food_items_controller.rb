module Api
  module V1
    class OrderFoodItemsController < ::Api::BaseController
      ...
      # GET /food_items.json
      def index
        json_response(current_order.order_food_items)
      end
      ...
      # GET /food_items/new
      def new
        json_response(current_order.order_food_items.new)
      end
      ...
      def create
        json_response(current_order.order_food_items.create!(food_item_params), :created)
      end
      ...
      private
        ...
        def set_food_item
          @food_item = current_order.order_food_items.find_by(uuid: params[:id])
        end
        ...
        def food_item_params
          params.require(:order_food_item).permit(:name, :price, :image_url, description_attributes: [:id, :content, :_destroy])
        end
    end
  end
end
